...
<html>
  <head>
 <title>Puzzle and Spellbee</title>
<link rel="stylesheet" type="text/css" href="puzzleandspellbee.css">
</head>
<body>
<div id="frame0">
    <header id="header">
...
function puzzle(){
        const PUZZLE_DIFFICULTY=<?php echo $diff;?>;
...
<iframe src="spellbee.php" id="iframe1"></iframe>
</div>
<div  id="copy1">
<p id="copy">

&copy; EEDG. All rights reserved.</p>
</div>
